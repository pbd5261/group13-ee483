...
from sensor_msgs.msg import LanePose, Twist2DStamped
...
class LaneDetector: 
    def __init__(self):
        ...
        rospy.Subscriber(f"/{veh_name}/lane_filter_node/lane_pose", LanePose, self.processor, queue_size=1, buff_size= 2**24)
        rospy.pub_1 = rospy.Publisher('/ee483mm13/car_cmd_switch_node/cmd', Twist2DStamped, queue_size=10)
        self.pub_phi = rospy.Publisher("avg_phi", LanePose, queue_size=32)
